/*
 * $Id: libgenders_testcases.h,v 1.2 2003-03-14 22:36:38 achu Exp $
...
struct {
  ...
  {GENDERS_TESTATTR,         IS_NOT_NULL_DESTROYED, GOOD_NODENAME, IS_NULL,           NO_VALUE,      -1,      GENDERS_ERR_MAGIC     },
  {GENDERS_TESTATTR,         IS_NOT_NULL_DESTROYED, GOOD_NODENAME, IS_NOT_NULL,       NO_VALUE,      -1,      GENDERS_ERR_MAGIC     },
  {GENDERS_TESTATTR,         IS_NOT_NULL_DESTROYED, BAD_NODENAME,  IS_NULL,           NO_VALUE,      -1,      GENDERS_ERR_MAGIC     },
  {GENDERS_TESTATTR,         IS_NOT_NULL_DESTROYED, BAD_NODENAME,  IS_NOT_NULL,       NO_VALUE,      -1,      GENDERS_ERR_MAGIC     },
