...
install man/llnl/libgendersllnl.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/gendersllnl.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_getaltnodes.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_isaltnode.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_altnodelist.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_altnodelist_create.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_get_cluster.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_getaltnodes_preserve.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_isnode_or_altnode.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_altnodelist_clear.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_altnodelist_destroy.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_to_gendname.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_to_altname.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_to_gendname_preserve.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_to_altname_preserve.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_to.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_string_to_gendnames.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_string_to_altnames.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_string_to_gendnames_preserve.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_string_to_altnames_preserve.3.gz $RPM_BUILD_ROOT/usr/man/man3
install man/llnl/genders_string.3.gz $RPM_BUILD_ROOT/usr/man/man3
cd man/; gzip *.3; cd ..
